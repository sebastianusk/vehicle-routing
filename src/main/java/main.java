...
public class main {
    public static void main(String[] args){
        ...
        int numClients = 5; // number of nodes + 1 because depot also count as nodes
        int numVehicle = 3; // there are 3 vehicle
        int maxNeighbor = 1000; // more is better, cost computing time
        int tolerance = 5; // more is better, cost computing time
        int capacity = 999; // vehicle capacity
        ...
        SimpleMatrix bestSolution = null;
    ...
    private static Double calcObj(SimpleMatrix solution, SimpleMatrix distanceMatrix) {
        Double calcObj = 0.0;
    ...
    private static int minRelativeDistance(double client, SimpleMatrix distanceMatrix, List<Integer> clientsUpdated) {
        int nearestClient = 0;
